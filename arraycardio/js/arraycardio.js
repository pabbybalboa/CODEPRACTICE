...
// Get your shorts on - this is an array workout!
    ...
    const inventors = [
      ...
      let inventorsFilter = inventors.filter(inventor => inventor.year >= 1500 && inventor.year < 1600)
      console.log(inventorsFilter)
      
      // Array.prototype.map()
      // 2. Give us an array of the inventors first and last names
      let firstLast = inventors.map(function(inventors){
      ...
      let birthDateArr = inventors.sort(function(a,b){
